...
//     $date2 = date_create($pinjam->tgl_balik);
...
//             echo '
// 												<br>
// 												<small style="color:red;">Denda maks. 30 hari</small>
// 												<p style="color:red;font-size:18px;">

// 												' . $this->M_Admin->rp($jml * ($dd->harga_denda * 30)) . '
// 												</p><small style="color:#333;">* Untuk ' . $jml . ' Buku</small>';
//         } else {
//             echo $gap . ' hari';
//             $dd = $this->M_Admin->get_tableid_edit('tbl_biaya_denda', 'stat', 'Aktif');
//             echo '<p style="color:red;font-size:18px;">
// 												' . $this->M_Admin->rp($jml * ($dd->harga_denda * $gap)) . '
// 												</p><small style="color:#333;">* Untuk ' . $jml . ' Buku</small>';
...
if ($pinjam->status == 'Di Kembalikan') {
	...
	$jml = $this->db->query("SELECT * FROM tbl_pinjam WHERE pinjam_id = '$pinjam_id'")->num_rows();
	$now = date_create('now');
	$return = date_create($pinjam->tgl_balik);
	$diff = date_diff($now, $return);
