	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			<?php if ($this->session->userdata('level') == 'Petugas') { ?>
				...
				<li class="treeview 
				<?php if ($this->uri->uri_string() == 'reservasi') {
					echo 'active';
				} ?>
				<?php if ($this->uri->uri_string() == 'reservasi/diterima') {
					echo 'active';
				} ?>
				<?php if ($this->uri->uri_string() == 'reservasi/ditolak') {
					echo 'active';
				} ?>
				<?php if ($this->uri->uri_string() == 'reservasi/detailReservasiPetugas/' . $this->uri->segment('3')) {
					echo 'active';
				} ?>
				">
				<a href="#">
				...
				<ul class="treeview-menu">
					<li class="<?php if ($this->uri->uri_string() == 'reservasi') {
						echo 'active';
					} ?>
						">
						<a href="<?php echo base_url("reservasi"); ?>" class="cursor">
							<span class="fa fa-upload"></span> Belum Diperiksa

						</a>
					</li>
					<li class="<?php if ($this->uri->uri_string() == 'reservasi/diterima') {
						echo 'active';
					} ?>">
						<a href="<?php echo base_url("reservasi/diterima"); ?>" class="cursor">
							<span class="fa fa-download"></span> Diterima
						</a>
					</li>
					<li class="<?php if ($this->uri->uri_string() == 'reservasi/ditolak') {
						echo 'active';
					} ?>">
						<a href="<?php echo base_url("reservasi/ditolak"); ?>" class="cursor">
							<span class="fa fa-download"></span> Ditolak
						</a>
					</li>
				</ul>
			</li>
			...
			<?php if ($this->session->userdata('level') == 'Anggota') { ?>
				...
				<li class="<?php if ($this->uri->uri_string() == 'reservasi/reservasi_saya') {
					echo 'active';
				} ?>">
					<a href="<?php echo base_url("reservasi/reservasi_saya"); ?>" class="cursor">
						<i class="fa fa-upload"></i> <span>Reservasi Buku</span>
					</a>
				</li>
